...
public class NumberGuesserPart2{
	public static void main(String[] args) {
		//there's a lot of repeated code and it's not the cleanest. We'll see later how to improve this
		try (Scanner input = new Scanner(System.in);){
			...
			while(input.hasNext()) {
				...
				//we won't output the error since it should be expected to be a number paring problem
